...
* \[1.13+/1.20+] Synced the contents of `ms_my.json` and `zlm_arab.json` with the [JawiCraft Language Pack](https://modrinth.com/resourcepack/jawicraft-language-pack)
